...
public class OwnerController {
    ...
    public String dashboard(Model model) {
        ...
        model.addAttribute("totalMedicines", medicineService.countByOwner(ownerId));
        model.addAttribute("totalCustomers", customerService.countByOwner(ownerId));
        model.addAttribute("todaySales", saleService.getTodaySalesByOwner(ownerId));
        model.addAttribute("lowStock", medicineService.countLowStockByOwner(ownerId, 10));
        model.addAttribute("recentSales", saleService.getRecentSalesByOwner(ownerId));
    ...
    public String branchDetail(@PathVariable Long id, Model model) {
        ...
        model.addAttribute("recentSales", saleService.getRecentSalesByBranch(id));
