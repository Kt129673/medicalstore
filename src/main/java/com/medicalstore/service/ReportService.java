...
public class ReportService {
    ...
    public DailyReportData generateDailyReport(LocalDateTime startOfDay, LocalDateTime endOfDay) {
        ...
        double totalDiscount = sales.stream().mapToDouble(s -> s.getDiscountAmount() != null ? s.getDiscountAmount() : 0.0).sum();
    ...
    public MonthlyReportData generateMonthlyReport(LocalDateTime startOfMonth, LocalDateTime endOfMonth, YearMonth yearMonth) {
        ...
        Map<LocalDate, Double> dailyRevenue = sales.stream()
            .collect(Collectors.groupingBy(
                ...
                Collectors.summingDouble(s -> s.getFinalAmount() != null ? s.getFinalAmount() : s.getTotalAmount())
            ));
        ...
        String peakDayStr = peakDay != null ? peakDay.getKey().format(DateTimeFormatter.ofPattern("dd MMM yyyy")) : "N/A";
