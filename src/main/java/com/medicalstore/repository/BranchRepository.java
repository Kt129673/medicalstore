...
public interface BranchRepository extends JpaRepository<Branch, Long> {
       ...
       List<Object[]> getExpiringCountsByOwner(Long ownerId, java.time.LocalDate startDate,
       ...
       @Query("SELECT u.branch.id, COUNT(u) FROM com.medicalstore.model.User u " +
                     "JOIN u.roles r WHERE u.branch.owner.id = :ownerId AND r = 'SHOPKEEPER' " +
                     "AND u.enabled = true GROUP BY u.branch.id")
       ...
       List<Object[]> getSalesTotalsByOwner(Long ownerId, java.time.LocalDateTime startDate,
